...
2. Enter the following comands one at a time:
  ...
  *cd "paste your file path to Taglab folder here" -- changing working directory to correct file path
  * python Taglab.py -- opening Taglab

Note: This new version of Taglab does not work on MAC systems as of yet.
